    ...
    if st.button("ပုံကို AI ဖြင့် စစ်ဆေးမည်"):
        with st.spinner("မျက်နှာပုံကို AI ဖြင့် သုံးသပ်နေပါပြီ... ခဏစောင့်ပါ။"):
            try:
                ...
                prompt = (
                    "ကျေးဇူးပြု၍ ဤမျက်နှာပုံကို လေ့လာပြီး အောက်ပါအချက် (၈) ချက်ကို လုံးဝ (လုံးဝ) မြန်မာဘာသာသီးသန့်ဖြင့်သာ အသေးစိတ် သုံးသပ်ပေးပါ။ "
                    "စဉ်းစားတွေးခေါ်ပုံများ (<think> ကဲ့သို့သော အပိုင်းများ) လုံးဝမထည့်ပါနှင့်။ အင်္ဂလိပ်စာလုံး လုံးဝ (လုံးဝ) မပါစေဘဲ မြန်မာဘာသာဖြင့်သာ တိုက်ရိုက်ထုတ်ပေးပါ-\n"
                    ...
                    "၆။ သုံးသင့်သည့် Skincare ပစ္စည်းများနှင့် ပါဝင်ပစ္စည်းများ\n"
                    "၇။ ဤပစ္စည်းများကို မြန်မာနိုင်ငံတွင် ဝယ်ယူရရှိနိုင်မည့်နေရာများ\n"
                    "၈။ အစားအသောက်နှင့် နေထိုင်မှုပုံစံ အကြံပြုချက်များ\n"
